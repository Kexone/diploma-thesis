...
\end{tabular}
\end{table}
Z výše umístěných tabulek můžeme pozorovat, jak se program jinak choval na každém zařízení. Tohle mohlo být způsobeno různými faktory, například jiným kompilátorem nebo jiným druhem zaokrouhlení. 
