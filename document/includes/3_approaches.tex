...
\subsection{Metoda detekce v kombinaci detekcí pohybu} % @TODO 
...
\begin{itemize}
  \item{\textbf{Konvoluce} - tyto vrstvy provádějí konvoluci nad vstupy do neuronové sítě.} %TODO
