...
\input{includes/4_datasets.tex}
\input{includes/5_1_used_libs.tex}
\input{includes/5_2_opencv.tex}
\input{includes/5_3_dlib.tex} 
\input{includes/6_o_aplikaci.tex}
\input{includes/7_testing_devices.tex}
\input{includes/8_experiments.tex}
\input{includes/9_zaver.tex}
%
\input{includes/references.tex}

\appendix
\input{includes/_appendix.tex}
\end{document}